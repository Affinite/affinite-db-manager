=== Affinite DB Manager ===
Contributors: affinite
Tags: database, admin, management, tools
...
Yes, the plugin includes multiple security layers including capability checks, table locking, and email-based access control.

= Can I modify WordPress core tables? =

Core WordPress tables are protected by default. You can unlock them manually, but this is not recommended.
